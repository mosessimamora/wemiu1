...
const YearbookLayout = ({ children, showNav = true, title }: YearbookLayoutProps) => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-yearbook-cream overflow-hidden">
      {/* Background gradient effect */}
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-yearbook-cream to-yearbook-cream/70 -z-10"></div>
      
      {/* Decorative elements */}
      <div className="absolute top-20 left-10 w-40 h-40 rounded-full bg-yearbook-gold/10 blur-3xl -z-5"></div>
      <div className="absolute bottom-20 right-10 w-60 h-60 rounded-full bg-yearbook-gold/10 blur-3xl -z-5"></div>
